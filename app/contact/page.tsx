    ...
    <div className="min-h-screen bg-white text-gray-900">
      <div className="max-w-4xl mx-auto p-10 md:p-20 font-sans leading-relaxed">
        ...
        <p className="text-lg text-gray-600 mb-10">
          Have questions about your audit or a payment? Were here to help.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <section className="space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-700">
                ...
                [26TF MIG flats, Guru Gobind Singh Avenue
          ...
          <section className="bg-gray-50 p-8 rounded-2xl border border-gray-100 text-black">
            <form action="https://api.web3forms.com/submit" method="POST" className="space-y-4 text-black">
              {/* Replace with your real Access Key from Web3Forms */}
              <input type="hidden" name="access_key" value="660dea3e-835d-4eb0-acb4-ad8aa32765c9" />
